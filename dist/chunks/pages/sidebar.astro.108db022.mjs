...
import { $ as $$LayoutSidebar, a as $$DashBoard } from './dashboard.astro.60d8df36.mjs';
...
const $$Sidebar$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "LayoutSidebar", $$LayoutSidebar, {}, { "default": ($$result2) => renderTemplate`
	${maybeRenderHead()}<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
...
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/playground/sidebar.astro", void 0);

const $$file$1 = "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/playground/sidebar.astro";
const $$url$1 = "/playground/sidebar";
...
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/layouts/sidebar.astro", void 0);

const $$file = "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/layouts/sidebar.astro";
