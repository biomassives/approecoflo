/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, f as renderComponent, m as maybeRenderHead, d as addAttribute, F as Fragment } from '../astro.9602e15c.mjs';
import { $ as $$LayoutSidebar } from './dashboard.astro.60d8df36.mjs';
import { h as $$NavPagination } from './kitchen-sink.astro.7a93a300.mjs';
import { f as fetchData, a as asset } from './404.astro.4f7e7050.mjs';
import 'html-escaper';
...
const $$CrudUsers = createComponent(async ($$result, $$props, $$slots) => {
				...
				<div class="overflow-hidden shadow">
					<table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
						...
						<tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
							${users.map((user) => renderTemplate`<div>
										<tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
											...
											<td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
												<img class="w-10 h-10 rounded-full"${addAttribute(asset(`/images/users/${user.avatar}`), "src")}${addAttribute(`${user.name} avatar`, "alt")}>
											...
											<td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
												<div class="flex items-center">
													${user.status === "Active" ? renderTemplate`<div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>` : renderTemplate`<div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div>`}
													${user.status}
												</div>
											</td>
...
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/modules/CrudUsers.astro", void 0);
...
const $$Users = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "LayoutSidebar", $$LayoutSidebar, {}, { "default": ($$result2) => renderTemplate`
	${renderComponent($$result2, "CrudUsers", $$CrudUsers, {})}
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/crud/users.astro", void 0);

const $$file = "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/crud/users.astro";
const $$url = "/crud/users";
