/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, f as renderComponent, d as addAttribute, b as renderSlot } from '../astro.9602e15c.mjs';
import { b as $$CopyrightNotice, a as asset, u as url, c as $$LayoutCommon } from './404.astro.4f7e7050.mjs';
/* empty css                               */
...
const $$FooterSidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
...
${renderComponent($$result, "CopyrightNotice", $$CopyrightNotice, {})}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/app/FooterSidebar.astro", void 0);
...
const $$ColorModeSwitcher = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/components/ColorModeSwitcher.astro", void 0);
...
const $$GitHubButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<div class="hidden mr-3 -mb-1 sm:block">\n	<a class="github-button"', ' data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true"', '>Star</a>\n</div>\n\n<script async defer src="https://buttons.github.io/buttons.js"><\/script>'])), maybeRenderHead(), addAttribute(`https://github.com/${repository}`, "href"), addAttribute(`Star ${repository} on GitHub`, "aria-label"));
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/components/GitHubButton.astro", void 0);
...
const $$SearchInput = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<form action="#" method="GET" class="hidden lg:block lg:pl-3.5">
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/components/SearchInput.astro", void 0);
...
const $$NavBarSidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
		...
		<div class="flex items-center justify-between">
			<div class="flex items-center justify-start">
				...
				<a href="/" class="flex ml-2 md:mr-24">
					<img${addAttribute(asset("images/approvideologo.svg"), "src")} class="h-8 mr-3" alt="Approvideo">
					<span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Approvideo</span>
				</a>
			...
			<div class="flex items-center">
				${renderComponent($$result, "GitHubButton", $$GitHubButton, { "repository": "themesberg/flowbite-astro-admin-dashboard" })}
					...
					<div>
						<a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
							<div class="flex-shrink-0">
								<img class="rounded-full w-11 h-11"${addAttribute(asset("images/users/bonnie-green.png"), "src")} alt="Jese image">
						...
						<a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
							<div class="flex-shrink-0">
								<img class="rounded-full w-11 h-11"${addAttribute(asset("images/users/jese-leos.png"), "src")} alt="Jese image">
						...
						<a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
							<div class="flex-shrink-0">
								<img class="rounded-full w-11 h-11"${addAttribute(asset("images/users/joseph-mcfall.png"), "src")} alt="Joseph image">
						...
						<a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
							<div class="flex-shrink-0">
								<img class="rounded-full w-11 h-11"${addAttribute(asset("images/users/leslie-livingston.png"), "src")} alt="Leslie image">
						...
						<a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
							<div class="flex-shrink-0">
								<img class="rounded-full w-11 h-11"${addAttribute(asset("images/users/robert-brown.png"), "src")} alt="Robert image">
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/app/NavBarSidebar.astro", void 0);

const $$Astro$3 = createAstro("http://localhost:2121");
const $$SideBar = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$SideBar;
  return renderTemplate`<!-- TODO: Dynamic dropdowns -->${maybeRenderHead()}<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
    ...
    "dark:scrollbar-thumb-slate-900 dark:scrollbar-track-gray-800"
			...
			<div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
				<ul class="pb-2 space-y-2">
					...
					<li>
						<a${addAttribute(url(), "href")} class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
					...
					<li>
						...
						<ul id="dropdown-layouts" class="hidden py-2 space-y-2">
							<li>
								<a${addAttribute(url("layouts/stacked"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a>
							</li>
							<li>
								<a${addAttribute(url("layouts/sidebar"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sidebar</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul id="dropdown-crud" class="hidden space-y-2 py-2">
							...
							<li>
								...
								<a${addAttribute(url("crud/products"), "href")} class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Products</a>
							</li>
							<li>
								<!--  {{ if eq $page_slug "users" }} -->
								<!-- bg-gray-100 dark:bg-gray-700 -->
								<a${addAttribute(url("crud/users"), "href")} class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Users</a>
							</li>
						</ul>
					</li>
					<li>
					...
					<li>
						...
						<ul id="dropdown-pages" class="hidden py-2 space-y-2">
							<li>
								<a${addAttribute(url("pages/pricing"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pricing</a>
							</li>
							<li>
								<a${addAttribute(url("pages/maintenance"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Maintenance</a>
							</li>
							<li>
								<a${addAttribute(url("pages/404"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">404 not found</a>
							</li>
							<li>
								<a${addAttribute(url("pages/500"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">500 server error</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul id="dropdown-auth" class="hidden py-2 space-y-2">
							<li>
								<a${addAttribute(url("authentication/sign-in"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign in</a>
							</li>
							<li>
								<a${addAttribute(url("authentication/sign-up"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sign up</a>
							</li>
							<li>
								<a${addAttribute(url("authentication/forgot-password"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Forgot password</a>
							</li>
							<li>
								<a${addAttribute(url("authentication/reset-password"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Reset password</a>
							</li>
							<li>
								<a${addAttribute(url("authentication/profile-lock"), "href")} class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Profile lock</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul id="dropdown-playground" class="hidden space-y-2 py-2">
							<li>
								...
								<!--  bg-gray-100 dark:bg-gray-700 -->
								<a${addAttribute(url("playground/stacked"), "href")} class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a>
								<!-- <a
							...
							<li>
								...
								<!--  bg-gray-100 dark:bg-gray-700 -->
								<a${addAttribute(url("playground/sidebar"), "href")} class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Sidebar</a>
								<a${addAttribute(url("playground/data"), "href")} class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">API data</a>
							</li>
						</ul>
					</li>
				</ul>
				<div class="pt-2 space-y-2">
					<a${addAttribute("https://github.com/themesberg/flowbite-astro-admin-dashboard", "href")} target="_blank" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/app/SideBar.astro", void 0);
...
const $$LayoutSidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "LayoutCommon", $$LayoutCommon, {}, { "default": ($$result2) => renderTemplate`
	${renderComponent($$result2, "NavBarSidebar", $$NavBarSidebar, {})}

	${renderComponent($$result2, "SideBar", $$SideBar, {})}

	${maybeRenderHead()}<div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
		<div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900 min-h-screen">
			${renderSlot($$result2, $$slots["default"])}

			${renderComponent($$result2, "FooterSidebar", $$FooterSidebar, {})}
		</div>
	</div>
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/app/LayoutSidebar.astro", void 0);

const $$Astro$1 = createAstro("http://localhost:2121");
const $$DashBoard = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$DashBoard;
  return renderTemplate`${maybeRenderHead()}<div class="px-4 pt-6">
				...
				<div class="hidden pt-4" id="faq" role="tabpanel" aria-labelledby="faq-tab">
					<ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
						<li class="py-3 sm:py-4">
							<div class="flex items-center justify-between">
								<div class="flex items-center min-w-0">
									<img class="flex-shrink-0 w-10 h-10"${addAttribute(asset("images/products/iphone.png"), "src")} alt="imac image">
									<div class="ml-3">
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center justify-between">
								<div class="flex items-center min-w-0">
									<img class="flex-shrink-0 w-10 h-10"${addAttribute(asset("images/products/imac.png"), "src")} alt="imac image">
									<div class="ml-3">
										<p class="font-medium text-gray-900 truncate dark:text-white">
											Apple iMac 27"
										</p>
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center justify-between">
								<div class="flex items-center min-w-0">
									<img class="flex-shrink-0 w-10 h-10"${addAttribute(asset("images/products/watch.png"), "src")} alt="watch image">
									<div class="ml-3">
										<p class="font-medium text-gray-900 truncate dark:text-white">
											Apple Watch SE
										</p>
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center justify-between">
								<div class="flex items-center min-w-0">
									<img class="flex-shrink-0 w-10 h-10"${addAttribute(asset("images/products/ipad.png"), "src")} alt="ipad image">
									<div class="ml-3">
										<p class="font-medium text-gray-900 truncate dark:text-white">
											Apple iPad Air
										</p>
					...
					<ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
						<li class="py-3 sm:py-4">
							<div class="flex items-center space-x-4">
								<div class="flex-shrink-0">
									<img class="w-8 h-8 rounded-full"${addAttribute(asset("images/users/neil-sims.png"), "src")} alt="Neil image">
								</div>
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center space-x-4">
								<div class="flex-shrink-0">
									<img class="w-8 h-8 rounded-full"${addAttribute(asset("images/users/bonnie-green.png"), "src")} alt="Neil image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="font-medium text-gray-900 truncate dark:text-white">
										Bonnie Green
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center space-x-4">
								<div class="flex-shrink-0">
									<img class="w-8 h-8 rounded-full"${addAttribute(asset("images/users/michael-gough.png"), "src")} alt="Neil image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="font-medium text-gray-900 truncate dark:text-white">
										Michael Gough
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center space-x-4">
								<div class="flex-shrink-0">
									<img class="w-8 h-8 rounded-full"${addAttribute(asset("images/users/thomas-lean.png"), "src")} alt="Neil image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="font-medium text-gray-900 truncate dark:text-white">
										Thomes Lean
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center space-x-4">
								<div class="flex-shrink-0">
									<img class="w-8 h-8 rounded-full"${addAttribute(asset("images/users/lana-byrd.png"), "src")} alt="Neil image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="font-medium text-gray-900 truncate dark:text-white">
										Lana Byrd
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/modules/DashBoard.astro", void 0);
...
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/dashboard.astro", void 0);

const $$file = "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/dashboard.astro";
const $$url = "/dashboard";
...
export { $$LayoutSidebar as $, $$DashBoard as a, dashboard as d };
