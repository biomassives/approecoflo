/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, f as renderComponent } from '../astro.9602e15c.mjs';
import { $ as $$LayoutSidebar } from './dashboard.astro.60d8df36.mjs';
import { a as asset } from './404.astro.4f7e7050.mjs';
import { e as $$ToggleSwitch } from './kitchen-sink.astro.7a93a300.mjs';
import 'html-escaper';
...
const $$PictureUploader = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$PictureUploader;
  const { title } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"${addAttribute(asset("images/users/bonnie-green-2x.png"), "src")} alt="Jese picture">
<div>
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/components/PictureUploader.astro", void 0);
...
const $$UserSettings = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
	...
	<div class="col-span-full xl:col-auto">
		<div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
			<div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
				${renderComponent($$result, "PictureUploader", $$PictureUploader, { "title": "Profile picture" })}
			</div>
		</div>
		<div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
...
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/modules/UserSettings.astro", void 0);
...
` })}`;
}, "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/settings.astro", void 0);

const $$file = "/home/greg/f1/flowbite-astro-admin-dashboard/src/pages/settings.astro";
const $$url = "/settings";
