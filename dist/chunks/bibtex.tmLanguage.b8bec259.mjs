...
const version = "https://github.com/jlelong/vscode-latex-basics/commit/36411b38cf4ed18e02050249e2162b1316488686";
const name = "bibtex";
const scopeName = "text.bibtex";
const comment = "Grammar based on description from https://github.com/aclements/biblib\n";
const patterns = [
	{
		match: "@(?i:comment)(?=[\\s{(])",
		captures: {
